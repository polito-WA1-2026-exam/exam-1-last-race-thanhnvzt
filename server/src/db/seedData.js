...
export const seedStations = [
  ...
  { name: 'Central Spire', x: 360, y: 120, isInterchange: true },
  { name: 'Harbor Market', x: 500, y: 120 },
  { name: 'West Garden', x: 640, y: 120, isInterchange: true },
  { name: 'North Library', x: 360, y: 40 },
  { name: 'Glassworks', x: 470, y: 250, isInterchange: true },
  { name: 'River Forum', x: 360, y: 360, isInterchange: true },
  { name: 'South Arena', x: 640, y: 360, isInterchange: true },
  { name: 'Old Foundry', x: 220, y: 260, isInterchange: true },
  { name: 'Hill Observatory', x: 500, y: 430 },
  { name: 'East Depot', x: 640, y: 430, isInterchange: true },
  { name: 'Clocktower', x: 640, y: 250, isInterchange: true },
