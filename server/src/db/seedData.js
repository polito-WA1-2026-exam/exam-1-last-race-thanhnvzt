...
export const seedStations = [
  ...
  { name: 'Cau Giay', x: 315, y: 290, isInterchange: true },
  { name: 'Cat Linh', x: 395, y: 325, isInterchange: true },
  { name: 'Ha Noi Station', x: 455, y: 355, isInterchange: true },
  { name: 'Long Bien', x: 545, y: 310, isInterchange: true },
  { name: 'Yen Vien', x: 650, y: 245 },
  { name: 'Ngoc Hoi', x: 455, y: 460 },
  { name: 'Giap Bat', x: 455, y: 410 },
  { name: 'Ha Dong', x: 215, y: 420, isInterchange: true },
